...
- [x] RLS: Row Level Security habilitado en ambas tablas: `games` y `scores` (verificado SPEC 14)
- [ ] Minimum password length — mínimo 8 caracteres (dashboard — ver `supabase-auth-dashboard.md`)
- [ ] Leaked password protection — (el warning 4) (dashboard — ver `supabase-auth-dashboard.md`)
- [ ] Max signup rate — limitar signups por IP (anti-bot) (dashboard — ver `supabase-auth-dashboard.md`)
- [x] Headers de seguridad en Next.js (`next.config.ts` → `headers()`, SPEC 14)
